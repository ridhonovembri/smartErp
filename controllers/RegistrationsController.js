...
exports.getByPk = (req, res) => {
    registrationsService.getByPk(req.params.id)
    .then(result => {
        res.status(200).send(JSON.stringify(result));
    })
    .catch(err => {
...
exports.getByStatus = (req, res) => {
    registrationsService.getByStatus(req.params.status)
    .then(result => {
        res.status(200).send(JSON.stringify(result));
    })
    .catch(err => {
...
exports.create = (req, res) => {
    registrationsService.create(req.body)
    .then(result => {
...
exports.update = (req, res) => {
    ...
    registrationsService.update(id, req.body)
    .then((result) => {      
